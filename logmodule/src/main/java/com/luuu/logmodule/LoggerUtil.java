...
import com.luuu.datamodule.FileDataUtilJ.FileIOUtils;
...
public class LoggerUtil {
    ...
    private static boolean isLog() {
        return LoggerManager.isForceLog() || BuildConfig.DEBUG && LoggerManager.isIsDebug();
    }

    private static void customLog(int priority, Throwable throwable, String tag, String msg) {
        if (isLog()) {
    ...
    public static void d(String tag, String msg, Object... args) {
        ...
        customLog(Logger.DEBUG, null, tag, message);
    }
    ...
    public static void v(String tag, String msg, Object... args) {
        String message = createMessage(msg, args);
        customLog(Logger.VERBOSE, null, tag, message);
    }
    ...
    public static void i(String tag, String msg, Object... args) {
        String message = createMessage(msg, args);
        customLog(Logger.INFO, null, tag, message);
    }
    ...
    public static void w(String tag, String msg, Object... args) {
        String message = createMessage(msg, args);
        customLog(Logger.WARN, null, tag, message);
    }
    ...
    public static void e(Throwable throwable, String tag, String msg, Object... args) {
        String message = createMessage(msg, args);
        customLog(Logger.ERROR, throwable, tag, message);
    }
    ...
    public static void wtf(String tag, String msg, Object... args) {
        String message = createMessage(msg, args);
        customLog(Logger.ASSERT, null, tag, message);
    }
    ...
    private static void writeLogFile(String tag, String msg) {
        if (!TextUtils.isEmpty(LoggerManager.getLogFilepath())) {
            FileIOUtils.writeFileFromString(LoggerManager.getLogFilepath(), tag + " : " + msg + "\n", true);
        }
    }
